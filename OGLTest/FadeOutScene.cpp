...
FadeOutScene::FadeOutScene(std::vector<boost::shared_ptr<BaseScene>> _fadeout_done_scenes)
{
...
void FadeOutScene::Tick(float _timespan, std::vector<boost::shared_ptr<BaseScene>>& _new_scenes)
{
	timeleft_-=_timespan;
	if(timeleft_ < 0)
	{
