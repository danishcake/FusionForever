...
bool SmallSquare::initialised_ = false;
int SmallSquare::outline_dl_ = 0;
int SmallSquare::outline_verts_index_ = 0;
int SmallSquare::fill_dl_ = 0;
int SmallSquare::fill_verts_index_ = 0;
...
void SmallSquare::initialise_fill(void)
{
...
void SmallSquare::initialise_outline(void)
{
	boost::shared_ptr<std::vector<Vector3f>> temp_outline = boost::shared_ptr<std::vector<Vector3f>>(new std::vector<Vector3f>());
	Vector3f rotate_point_ = Vector3f(2.5f,2.5f,0);

	temp_outline->push_back(Vector3f(0,0,0));	//0
	temp_outline->push_back(Vector3f(0,5,0));	//1
	temp_outline->push_back(Vector3f(5,5,0));	//2
	temp_outline->push_back(Vector3f(5,0,0));	//3
