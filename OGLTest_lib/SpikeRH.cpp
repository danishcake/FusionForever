...
bool SpikeRH::initialised_ = false;
int SpikeRH::outline_dl_ = 0;
int SpikeRH::outline_verts_index_ = 0;
int SpikeRH::fill_dl_ = 0;
int SpikeRH::fill_verts_index_ = 0;

SpikeRH::SpikeRH(void)
: Section()
{
	if(!initialised_)
	{
...
void SpikeRH::initialise_fill(void)
{
...
void SpikeRH::initialise_outline(void)
{
