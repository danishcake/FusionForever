...
bool WingRH::initialised_ = false;
int WingRH::outline_dl_ = 0;
int WingRH::outline_verts_index_ = 0;
int WingRH::fill_dl_ = 0;
int WingRH::fill_verts_index_ = 0;
...
void WingRH::initialise_fill(void)
{
...
void WingRH::initialise_outline(void)
{
