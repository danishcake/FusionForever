...
/**
  * The ShotgunArtillery fires fragmenting ammunition
  */
class ShotgunArtillery :
...
public:
   /**
     * Creates a ShotgunArtillery
     */
	ShotgunArtillery(void);
	virtual ~ShotgunArtillery(void);

   /**
     * Ticks the ShotgunArtillery
