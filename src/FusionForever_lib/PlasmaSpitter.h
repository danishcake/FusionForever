...
/**
  * The PlasmaSpitter class represents a section that fires many small fast PlasmaSeekers
  */
class PlasmaSpitter :
...
public:
   /**
     * Creates a PlasmaSpitter
     */
	PlasmaSpitter();
	virtual ~PlasmaSpitter(void);

   /**
     * Ticks the PlasmaSpitter
