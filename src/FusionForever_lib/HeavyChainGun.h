...
/**
  * The HeavyChainGun class represents a section that fires PlasmaRounds slowly at first, accelerating to extremely fast
  */
class HeavyChainGun :
...
public:
   /**
     * Creates a HeavyChainGun
     */
	HeavyChainGun(void);
	virtual ~HeavyChainGun(void);

   /**
     * Ticks the HeavyChainGun
